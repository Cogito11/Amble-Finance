...
import {
  Wallet, Plus, Trash2, AlertCircle, Archive
} from "lucide-react";
            ...
            >
              <div className="acc-top">
                ...
                <div className="row-actions">
                  <button className="icon-btn" onClick={(e) => { e.stopPropagation(); onDelete(a.id); }} aria-label="Delete account"><Trash2 size={14} /></button>
                </div>
              </div>
